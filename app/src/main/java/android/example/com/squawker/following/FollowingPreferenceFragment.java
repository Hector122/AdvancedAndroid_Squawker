...
public class FollowingPreferenceFragment extends PreferenceFragmentCompat
    ...
    //  When a SharedPreference changes, check which preference it is and subscribe or
    ...
    //  Make sure to register and unregister this as a Shared Preference Change listener, in
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (sharedPreferences.contains(key) && sharedPreferences instanceof SwitchPreferenceCompat) {
            ...
            if (isOn) {
                ...
                Log.d(LOG_TAG, "Unssubscribing to " + key);
            }
        }
    }
